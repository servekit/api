...
func (c *userServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.Pong, error) {
...
func (UnimplementedUserServiceServer) Ping(context.Context, *emptypb.Empty) (*v1.Pong, error) {
