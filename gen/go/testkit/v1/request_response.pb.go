...
var file_testkit_v1_request_response_proto_depIdxs = []int32{
	...
	236, // 43: testkit.v1.GetLoginLogsResponse.logs:type_name -> testkit.v1.LoginLog
	237, // 44: testkit.v1.ListGroupsResponse.groups:type_name -> testkit.v1.Group
	238, // 45: testkit.v1.ListGroupMembersResponse.members:type_name -> testkit.v1.GroupMember
	239, // 46: testkit.v1.ListGroupRolesResponse.roles:type_name -> testkit.v1.Role
	239, // 47: testkit.v1.ListRolesResponse.roles:type_name -> testkit.v1.Role
	240, // 48: testkit.v1.ListUserRolesResponse.roles:type_name -> testkit.v1.UserRole
	241, // 49: testkit.v1.ListPermissionsResponse.permissions:type_name -> testkit.v1.Permission
	242, // 50: testkit.v1.ListPermissionGroupsResponse.groups:type_name -> testkit.v1.PermissionGroup
	214, // 51: testkit.v1.GenerateUploadURLRequest.metadata:type_name -> testkit.v1.GenerateUploadURLRequest.MetadataEntry
	243, // 52: testkit.v1.GenerateUploadURLRequest.vendor:type_name -> storage.v1.Vendor
	244, // 53: testkit.v1.GenerateUploadURLRequest.visibility:type_name -> storage.v1.Visibility
	245, // 54: testkit.v1.GenerateUploadURLResponse.file_info:type_name -> testkit.v1.FileInfo
	215, // 55: testkit.v1.GenerateUploadURLResponse.headers:type_name -> testkit.v1.GenerateUploadURLResponse.HeadersEntry
	216, // 56: testkit.v1.GetSTSCredentialRequest.metadata:type_name -> testkit.v1.GetSTSCredentialRequest.MetadataEntry
	243, // 57: testkit.v1.GetSTSCredentialRequest.vendor:type_name -> storage.v1.Vendor
	246, // 58: testkit.v1.GetSTSCredentialRequest.ttl:type_name -> google.protobuf.Duration
	244, // 59: testkit.v1.GetSTSCredentialRequest.visibility:type_name -> storage.v1.Visibility
	245, // 60: testkit.v1.GetSTSCredentialResponse.file_info:type_name -> testkit.v1.FileInfo
	247, // 61: testkit.v1.BatchGetSTSCredentialRequest.files:type_name -> testkit.v1.UploadFileMeta
	246, // 62: testkit.v1.BatchGetSTSCredentialRequest.ttl:type_name -> google.protobuf.Duration
	244, // 63: testkit.v1.BatchGetSTSCredentialRequest.visibility:type_name -> storage.v1.Visibility
	248, // 64: testkit.v1.BatchGetSTSCredentialResponse.items:type_name -> testkit.v1.UploadCredentialItem
	245, // 65: testkit.v1.ConfirmUploadResponse.file_info:type_name -> testkit.v1.FileInfo
	249, // 66: testkit.v1.GenerateProcessURLRequest.ops:type_name -> testkit.v1.ImageProcessOp
	249, // 67: testkit.v1.GenerateCDNURLRequest.ops:type_name -> testkit.v1.ImageProcessOp
	246, // 68: testkit.v1.GenerateCDNURLRequest.ttl:type_name -> google.protobuf.Duration
	250, // 69: testkit.v1.ListMyFilesRequest.order_by:type_name -> storage.v1.SortField
	245, // 70: testkit.v1.ListMyFilesResponse.files:type_name -> testkit.v1.FileInfo
	250, // 71: testkit.v1.ListMyFilesPagedRequest.order_by:type_name -> storage.v1.SortField
	245, // 72: testkit.v1.ListMyFilesPagedResponse.files:type_name -> testkit.v1.FileInfo
	217, // 73: testkit.v1.UpdateMyFileRequest.metadata:type_name -> testkit.v1.UpdateMyFileRequest.MetadataEntry
	251, // 74: testkit.v1.ListMyAuditLogsRequest.action:type_name -> storage.v1.AuditAction
	252, // 75: testkit.v1.ListMyAuditLogsRequest.target_type:type_name -> storage.v1.AuditLogTargetType
	253, // 76: testkit.v1.ListMyAuditLogsResponse.logs:type_name -> testkit.v1.AuditLogEntry
	254, // 77: testkit.v1.AdminListFilesRequest.owner_type:type_name -> storage.v1.OwnerType
	250, // 78: testkit.v1.AdminListFilesRequest.order_by:type_name -> storage.v1.SortField
	255, // 79: testkit.v1.AdminListFilesResponse.files:type_name -> testkit.v1.AdminFileInfo
	254, // 80: testkit.v1.AdminGetQuotaRequest.owner_type:type_name -> storage.v1.OwnerType
	254, // 81: testkit.v1.AdminSetQuotaRequest.owner_type:type_name -> storage.v1.OwnerType
	254, // 82: testkit.v1.AdminGetStatsRequest.owner_type:type_name -> storage.v1.OwnerType
	256, // 83: testkit.v1.AdminGetStatsResponse.owner_stats:type_name -> testkit.v1.OwnerStats
	257, // 84: testkit.v1.AdminGetStatsResponse.provider_stats:type_name -> testkit.v1.ProviderStats
	258, // 85: testkit.v1.AdminGetStatsResponse.bucket_stats:type_name -> testkit.v1.BucketStats
	259, // 86: testkit.v1.AdminListProvidersResponse.providers:type_name -> testkit.v1.ProviderInfo
	260, // 87: testkit.v1.AdminListBucketsResponse.buckets:type_name -> testkit.v1.BucketInfo
	254, // 88: testkit.v1.AdminSoftDeleteOwnerFilesRequest.owner_type:type_name -> storage.v1.OwnerType
	254, // 89: testkit.v1.AdminDeleteOwnerRequest.owner_type:type_name -> storage.v1.OwnerType
	251, // 90: testkit.v1.AdminListAuditLogsRequest.action:type_name -> storage.v1.AuditAction
	252, // 91: testkit.v1.AdminListAuditLogsRequest.target_type:type_name -> storage.v1.AuditLogTargetType
	261, // 92: testkit.v1.AdminListAuditLogsRequest.status:type_name -> storage.v1.AuditLogStatus
	254, // 93: testkit.v1.AdminListAuditLogsRequest.owner_type:type_name -> storage.v1.OwnerType
	253, // 94: testkit.v1.AdminListAuditLogsResponse.logs:type_name -> testkit.v1.AuditLogEntry
	262, // 95: testkit.v1.SendEmailRequest.to:type_name -> testkit.v1.EmailAddress
	262, // 96: testkit.v1.SendEmailRequest.cc:type_name -> testkit.v1.EmailAddress
	262, // 97: testkit.v1.SendEmailRequest.bcc:type_name -> testkit.v1.EmailAddress
	262, // 98: testkit.v1.SendEmailRequest.reply_to:type_name -> testkit.v1.EmailAddress
	263, // 99: testkit.v1.SendEmailRequest.vendor:type_name -> messaging.v1.EmailVendor
	218, // 100: testkit.v1.SendEmailRequest.template_params:type_name -> testkit.v1.SendEmailRequest.TemplateParamsEntry
	264, // 101: testkit.v1.SendEmailRequest.scene:type_name -> messaging.v1.EmailScene
	262, // 102: testkit.v1.SendEmailRequest.from:type_name -> testkit.v1.EmailAddress
	265, // 103: testkit.v1.SendEmailRequest.attachments:type_name -> testkit.v1.EmailAttachment
	219, // 104: testkit.v1.SendSMSRequest.template_params:type_name -> testkit.v1.SendSMSRequest.TemplateParamsEntry
	266, // 105: testkit.v1.SendSMSRequest.vendor:type_name -> messaging.v1.SmsVendor
	267, // 106: testkit.v1.SendSMSRequest.scene:type_name -> messaging.v1.SmsScene
	268, // 107: testkit.v1.SendResponse.status:type_name -> messaging.v1.MessageStatus
	263, // 108: testkit.v1.SendResponse.email_vendor:type_name -> messaging.v1.EmailVendor
	266, // 109: testkit.v1.SendResponse.sms_vendor:type_name -> messaging.v1.SmsVendor
	263, // 110: testkit.v1.ListEmailsRequest.vendor:type_name -> messaging.v1.EmailVendor
	264, // 111: testkit.v1.ListEmailsRequest.scene:type_name -> messaging.v1.EmailScene
	268, // 112: testkit.v1.ListEmailsRequest.status:type_name -> messaging.v1.MessageStatus
	250, // 113: testkit.v1.ListEmailsRequest.sort_field:type_name -> storage.v1.SortField
	269, // 114: testkit.v1.ListEmailsRequest.sort_direction:type_name -> messaging.v1.SortDirection
	270, // 115: testkit.v1.ListEmailsResponse.records:type_name -> testkit.v1.EmailRecord
	266, // 116: testkit.v1.ListSMSRequest.vendor:type_name -> messaging.v1.SmsVendor
	267, // 117: testkit.v1.ListSMSRequest.scene:type_name -> messaging.v1.SmsScene
	268, // 118: testkit.v1.ListSMSRequest.status:type_name -> messaging.v1.MessageStatus
	250, // 119: testkit.v1.ListSMSRequest.sort_field:type_name -> storage.v1.SortField
	269, // 120: testkit.v1.ListSMSRequest.sort_direction:type_name -> messaging.v1.SortDirection
	271, // 121: testkit.v1.ListSMSResponse.records:type_name -> testkit.v1.SMSRecord
	263, // 122: testkit.v1.ListEmailsByCursorRequest.vendor:type_name -> messaging.v1.EmailVendor
	264, // 123: testkit.v1.ListEmailsByCursorRequest.scene:type_name -> messaging.v1.EmailScene
	268, // 124: testkit.v1.ListEmailsByCursorRequest.status:type_name -> messaging.v1.MessageStatus
	250, // 125: testkit.v1.ListEmailsByCursorRequest.sort_field:type_name -> storage.v1.SortField
	269, // 126: testkit.v1.ListEmailsByCursorRequest.sort_direction:type_name -> messaging.v1.SortDirection
	270, // 127: testkit.v1.ListEmailsByCursorResponse.records:type_name -> testkit.v1.EmailRecord
	266, // 128: testkit.v1.ListSMSByCursorRequest.vendor:type_name -> messaging.v1.SmsVendor
	267, // 129: testkit.v1.ListSMSByCursorRequest.scene:type_name -> messaging.v1.SmsScene
	268, // 130: testkit.v1.ListSMSByCursorRequest.status:type_name -> messaging.v1.MessageStatus
	250, // 131: testkit.v1.ListSMSByCursorRequest.sort_field:type_name -> storage.v1.SortField
	269, // 132: testkit.v1.ListSMSByCursorRequest.sort_direction:type_name -> messaging.v1.SortDirection
	271, // 133: testkit.v1.ListSMSByCursorResponse.records:type_name -> testkit.v1.SMSRecord
	263, // 134: testkit.v1.GetEmailStatsRequest.vendor:type_name -> messaging.v1.EmailVendor
	264, // 135: testkit.v1.GetEmailStatsRequest.scene:type_name -> messaging.v1.EmailScene
	272, // 136: testkit.v1.EmailStatsResponse.vendors:type_name -> testkit.v1.EmailVendorStats
	266, // 137: testkit.v1.GetSMSStatsRequest.vendor:type_name -> messaging.v1.SmsVendor
	267, // 138: testkit.v1.GetSMSStatsRequest.scene:type_name -> messaging.v1.SmsScene
	273, // 139: testkit.v1.SMSStatsResponse.vendors:type_name -> testkit.v1.SmsVendorStats
	274, // 140: testkit.v1.DashboardResponse.email_stats:type_name -> testkit.v1.EmailStats
	275, // 141: testkit.v1.DashboardResponse.sms_stats:type_name -> testkit.v1.SMSStats
	276, // 142: testkit.v1.DashboardResponse.quota:type_name -> testkit.v1.MyQuota
	277, // 143: testkit.v1.DashboardResponse.users:type_name -> testkit.v1.UsersSummary
	278, // 144: testkit.v1.ActivateResponse.slots:type_name -> testkit.v1.SlotSummary
	279, // 145: testkit.v1.HealthResponse.checks:type_name -> testkit.v1.HealthChecks
	280, // 146: testkit.v1.CreateKeyRequest.grants:type_name -> testkit.v1.EntitlementInput
	281, // 147: testkit.v1.CreateKeyResponse.key:type_name -> testkit.v1.KeyInfo
	281, // 148: testkit.v1.ShowKeyResponse.key:type_name -> testkit.v1.KeyInfo
	282, // 149: testkit.v1.ListKeysRequest.status:type_name -> license.v1.KeyStatus
	281, // 150: testkit.v1.ListKeysResponse.keys:type_name -> testkit.v1.KeyInfo
	281, // 151: testkit.v1.UpdateKeyResponse.key:type_name -> testkit.v1.KeyInfo
	281, // 152: testkit.v1.RevokeKeyResponse.key:type_name -> testkit.v1.KeyInfo
	281, // 153: testkit.v1.UnrevokeKeyResponse.key:type_name -> testkit.v1.KeyInfo
	283, // 154: testkit.v1.GrantModuleRequest.module:type_name -> license.v1.Module
	284, // 155: testkit.v1.GrantModuleRequest.kind:type_name -> license.v1.EntitlementKind
	231, // 156: testkit.v1.GrantModuleRequest.expires_at:type_name -> google.protobuf.Timestamp
	285, // 157: testkit.v1.GrantModuleResponse.entitlement:type_name -> testkit.v1.EntitlementInfo
	283, // 158: testkit.v1.RevokeModuleRequest.module:type_name -> license.v1.Module
	286, // 159: testkit.v1.ListKeyDevicesResponse.devices:type_name -> testkit.v1.DeviceSlotInfo
	283, // 160: testkit.v1.ShowTrialRequest.module:type_name -> license.v1.Module
	287, // 161: testkit.v1.ShowTrialResponse.trials:type_name -> testkit.v1.TrialInfo
	283, // 162: testkit.v1.ResetTrialRequest.module:type_name -> license.v1.Module
	288, // 163: testkit.v1.ShowPubKeyResponse.keys:type_name -> testkit.v1.SigningKeyInfo
	220, // 164: testkit.v1.IngestResponse.drops:type_name -> testkit.v1.IngestResponse.DropsEntry
	289, // 165: testkit.v1.ValidateBatchResponse.events:type_name -> testkit.v1.ValidateEventResult
	290, // 166: testkit.v1.CreateAppResponse.app:type_name -> testkit.v1.App
	290, // 167: testkit.v1.GetAppResponse.app:type_name -> testkit.v1.App
	291, // 168: testkit.v1.GetAppResponse.tokens:type_name -> testkit.v1.IngestTokenInfo
	292, // 169: testkit.v1.GetAppResponse.signing_keys:type_name -> testkit.v1.TelemetrySigningKeyInfo
	293, // 170: testkit.v1.GetAppResponse.rules:type_name -> testkit.v1.EventRule
	294, // 171: testkit.v1.GetAppResponse.versions:type_name -> testkit.v1.VersionInfo
	295, // 172: testkit.v1.UpdateAppRequest.auth_mode:type_name -> telemetry.v1.AuthMode
	231, // 173: testkit.v1.UpdateAppRequest.auth_grace_until:type_name -> google.protobuf.Timestamp
	290, // 174: testkit.v1.UpdateAppResponse.app:type_name -> testkit.v1.App
	293, // 175: testkit.v1.ReplaceEventRulesRequest.rules:type_name -> testkit.v1.EventRule
	293, // 176: testkit.v1.ReplaceEventRulesResponse.rules:type_name -> testkit.v1.EventRule
	296, // 177: testkit.v1.GetAppStatsResponse.days:type_name -> testkit.v1.DailyStat
	221, // 178: testkit.v1.GetAppStatsResponse.drops:type_name -> testkit.v1.GetAppStatsResponse.DropsEntry
	222, // 179: testkit.v1.GetAppStatsResponse.sig_fails:type_name -> testkit.v1.GetAppStatsResponse.SigFailsEntry
